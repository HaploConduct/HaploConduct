...
int main(int argc, char *argv[])
{
    ...
    desc.add_options()
        ...
        ("min_qual", po::value< double > (&program_settings.min_qual)->default_value(0.99), "set the minimum base quality (probability that it is correct) for a superread; otherwise an 'N' is inserted.")
        ...
        ("max_tip_len", po::value< unsigned int > (&program_settings.max_tip_len)->default_value(150), "set the minimum read length (bp) for allowing edges")
